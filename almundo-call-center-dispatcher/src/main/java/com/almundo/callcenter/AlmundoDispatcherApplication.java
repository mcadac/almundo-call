...
/**
 * Main class to set and run spring boot application
 * 
...
public class AlmundoDispatcherApplication implements RabbitListenerConfigurer {
	...
	public static void main(final String[] args) {
		...
		SpringApplication.run(AlmundoDispatcherApplication.class, args);
